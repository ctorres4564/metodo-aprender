...
4. "q": uma pergunta de múltipla escolha simples que testa compreensão real. Prefira perguntas sobre mecanismo, relação, causa, consequência, aplicação ou distinção entre conceitos. Evite perguntas que possam ser respondidas apenas reconhecendo uma definição decorada. A pergunta deve poder ser respondida usando apenas o conceito apresentado.
5. "options": exatamente 4 alternativas de resposta. Elas precisam ser difíceis de adivinhar por eliminação, mesmo por quem nunca leu o texto-fonte. Siga estas regras ao criar as 3 alternativas erradas:
   ...
   - Use como distratores conceitos próximos, inversões de causa e efeito, generalizações excessivas, confusões comuns e explicações parcialmente corretas.
